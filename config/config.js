Config({
  ...
  // =========================================================================
  // 9. جدول باقات وأسعار الكروت (يتم تعديل الأسعار والساعات والحجم من هنا)
  // =========================================================================
  profiles: [
    { price: "100 ريال", time: "0 ساعات", transfer: "0 ميجا" },
    { price: "150 ريال", time: "0 ساعات", transfer: "0 ميجا" },
    { price: "200 ريال", time: "0 ساعات", transfer: "0 ميجا" },
    { price: "250 ريال", time: "0 ساعات", transfer: "0 ميجا" },
    { price: "300 ريال", time: "0 ساعات", transfer: "0 ميجا" },
    { price: "500 ريال", time: "0 ساعات", transfer: "0 ميجا" },
    { price: "150 ريال", time: "مفتوح ", transfer: "مفتوح" },
  ],
